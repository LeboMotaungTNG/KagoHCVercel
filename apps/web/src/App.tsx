...
import OwnerManageEmployees from "./apps/Owner/ManageEmployees";
import OwnerEmployeesPage from "./apps/Owner/EmployeesPage";
...
const App: React.FC = () => (
  <Routes>
    ...
    <Route path="/owner/employees/create" element={<OwnerManageEmployees />} />
